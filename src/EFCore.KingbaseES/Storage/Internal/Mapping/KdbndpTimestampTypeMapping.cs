...
public class KdbndpTimestampTypeMapping : KdbndpTypeMapping {
  ...
  public KdbndpTimestampTypeMapping()
      : base("timestamp without time zone", typeof(DateTime),
             KdbndpDbType.Timestamp, KdbndpJsonTimestampReaderWriter.Instance) {
  }
  ...
  ///     when updating to a new Entity Framework Core release.
  /// </summary>
  protected KdbndpTimestampTypeMapping(
  ...
  protected override string ProcessStoreType(
      ...
      string _) => parameters.Precision is null
                       ? storeType
                       : $"timestamp({parameters.Precision}) without time zone";
  ...
  private string
  GenerateLiteralCore(object value) => FormatDateTime((DateTime)value);
  ...
  private static string FormatDateTime(DateTime dateTime) {
    ...
    return KdbndpTypeMappingSource.LegacyTimestampBehavior ||
  ...
  private sealed class KdbndpJsonTimestampReaderWriter
