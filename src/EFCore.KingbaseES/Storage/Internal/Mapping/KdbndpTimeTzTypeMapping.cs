...
public class KdbndpTimeTzTypeMapping : KdbndpTypeMapping {
  ...
  public KdbndpTimeTzTypeMapping()
      : base("time with time zone", typeof(DateTimeOffset), KdbndpDbType.TimeTz,
             JsonTimeTzReaderWriter.Instance) {}
  ...
  protected override string ProcessStoreType(
      ...
      string _) => parameters.Precision is null
                       ? storeType
                       : $"time({parameters.Precision}) with time zone";
  ...
  private sealed class JsonTimeTzReaderWriter
    ...
    /// <inheritdoc />
    public override void ToJsonTyped(Utf8JsonWriter writer,
