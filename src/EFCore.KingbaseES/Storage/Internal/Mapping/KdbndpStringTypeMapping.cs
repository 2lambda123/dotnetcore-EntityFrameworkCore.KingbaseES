...
/// <summary>
///     The base class for mapping Kdbndp-specific string types. It configures
...
public class KdbndpStringTypeMapping : StringTypeMapping, IKdbndpTypeMapping {
  ...
  /// </summary>
  public static new KdbndpStringTypeMapping Default { get;
}
...
///     to a new Entity Framework Core release.
/// </summary>
protected KdbndpStringTypeMapping(RelationalTypeMappingParameters parameters,
                                  KdbndpDbType kdbndpDbType)
    : base(parameters) {
  KdbndpDbType = kdbndpDbType;
}
...
///     to a new Entity Framework Core release.
/// </remarks>
public virtual KdbndpStringTypeMapping
Clone(KdbndpDbType KdbndpDbType) => new(Parameters, KdbndpDbType);
