...
/// </remarks>
public class KdbndpCharacterCharTypeMapping : CharTypeMapping,
                                              IKdbndpTypeMapping {
  /// <summary>
  ...
  /// </summary>
  public static new KdbndpCharacterCharTypeMapping Default { get;
}
= new("text");

/// <inheritdoc />
public virtual KdbndpDbType KdbndpDbType => KdbndpDbType.Char;
...
public KdbndpCharacterCharTypeMapping(string storeType)
    : this(new RelationalTypeMappingParameters(
          ...
          System.Data.DbType.StringFixedLength, unicode: false,
          fixedLength: true)) {}
...
///     to a new Entity Framework Core release.
/// </summary>
protected KdbndpCharacterCharTypeMapping(
