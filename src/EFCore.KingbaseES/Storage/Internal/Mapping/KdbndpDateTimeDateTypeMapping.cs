...
public class KdbndpDateTimeDateTypeMapping : KdbndpTypeMapping {
  ...
  public KdbndpDateTimeDateTypeMapping()
      : base("date", typeof(DateTime), KdbndpDbType.Date,
             KdbndpJsonDateTimeReaderWriter.Instance) {}
  ...
  ///     when updating to a new Entity Framework Core release.
  /// </summary>
  protected KdbndpDateTimeDateTypeMapping(
  ...
  private sealed class KdbndpJsonDateTimeReaderWriter
