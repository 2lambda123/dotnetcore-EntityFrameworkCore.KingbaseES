...
/// <remarks>
///     See:
///     https://www.KingbaseES.org/docs/current/static/datatype-net-types.html#DATATYPE-MACADDR8
/// </remarks>
public class KdbndpMacaddr8TypeMapping : KdbndpTypeMapping {
  ...
  public KdbndpMacaddr8TypeMapping()
      : base("macaddr8", typeof(PhysicalAddress), KdbndpDbType.MacAddr8,
  ...
  ///     when updating to a new Entity Framework Core release.
  /// </summary>
  protected KdbndpMacaddr8TypeMapping(
