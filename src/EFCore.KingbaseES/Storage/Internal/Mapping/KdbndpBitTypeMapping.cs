...
public class KdbndpBitTypeMapping : KdbndpTypeMapping {
  ...
  /// <summary>
  ///     Constructs an instance of the <see cref="KdbndpBitTypeMapping" />
  ///     class.
  /// </summary>
  public KdbndpBitTypeMapping()
      : base("bit", typeof(BitArray), KdbndpDbType.Bit,
             jsonValueReaderWriter: JsonBitArrayReaderWriter.Instance) {}
