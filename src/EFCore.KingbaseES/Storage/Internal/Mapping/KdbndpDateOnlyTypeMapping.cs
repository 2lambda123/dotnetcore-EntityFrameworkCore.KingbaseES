...
public class KdbndpDateOnlyTypeMapping : KdbndpTypeMapping {
  ...
  public KdbndpDateOnlyTypeMapping()
      : base("date", typeof(DateOnly), KdbndpDbType.Date,
             KdbndpJsonDateOnlyReaderWriter.Instance) {}
  ...
  ///     when updating to a new Entity Framework Core release.
  /// </summary>
  protected KdbndpDateOnlyTypeMapping(
  ...
  private sealed class KdbndpJsonDateOnlyReaderWriter
      : JsonValueReaderWriter<DateOnly> {
