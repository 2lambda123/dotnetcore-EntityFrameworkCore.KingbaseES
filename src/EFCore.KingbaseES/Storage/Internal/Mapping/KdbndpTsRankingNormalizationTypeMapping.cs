...
public class KdbndpTsRankingNormalizationTypeMapping : IntTypeMapping {
  ...
  /// </summary>
  public static new KdbndpTsRankingNormalizationTypeMapping Default { get;
}
= new();
...
public KdbndpTsRankingNormalizationTypeMapping()
    : base(new RelationalTypeMappingParameters(
          new CoreTypeMappingParameters(
              typeof(KdbndpTsRankingNormalization),
              new EnumToNumberConverter<KdbndpTsRankingNormalization, int>()),
          "integer")) {}
...
///     to a new Entity Framework Core release.
/// </summary>
protected KdbndpTsRankingNormalizationTypeMapping(
