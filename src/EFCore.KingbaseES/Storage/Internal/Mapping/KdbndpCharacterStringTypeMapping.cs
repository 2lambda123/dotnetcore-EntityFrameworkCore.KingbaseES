...
/// <summary>
///     Type mapping for the KingbaseES 'character' data type. Handles both CLR
///     strings and chars.
/// </summary>
/// <remarks>
///     See:
///     https://www.KingbaseES.org/docs/current/static/datatype-character.html
/// </remarks>
/// <inheritdoc />
public class KdbndpCharacterStringTypeMapping : KdbndpStringTypeMapping {
  ...
  /// </summary>
  public static new KdbndpCharacterStringTypeMapping Default { get;
}
= new("text");
...
///     </p>
///     <p>
///         Note that if a value converter is used and the CLR type isn't a
///         string at all, we just use the default value converter instead.
///     </p>
/// </remarks>
private static readonly ValueComparer<string> CharacterValueComparer =
    new((x, y) => EqualsWithoutTrailingWhitespace(x, y),
...
public KdbndpCharacterStringTypeMapping(string storeType, int size = 1)
    : this(new RelationalTypeMappingParameters(
          ...
          storeType, StoreTypePostfix.Size,
          System.Data.DbType.StringFixedLength, unicode: false, size,
          fixedLength: true)) {}
...
///     to a new Entity Framework Core release.
/// </summary>
protected KdbndpCharacterStringTypeMapping(
...
///     to a new Entity Framework Core release.
/// </summary>
protected override RelationalTypeMapping
Clone(RelationalTypeMappingParameters parameters) =>
    new KdbndpCharacterStringTypeMapping(new RelationalTypeMappingParameters(
        parameters.CoreParameters, parameters.StoreType, StoreTypePostfix.Size,
        parameters.DbType, parameters.Unicode, parameters.Size,
        parameters.FixedLength, parameters.Precision, parameters.Scale));
...
private static bool
    EqualsWithoutTrailingWhitespace(string? a, string? b) => (a, b) switch {
      (null, null) => true, (_, null) => false, (null, _) => false,
      _ => a.AsSpan().TrimEnd().SequenceEqual(b.AsSpan().TrimEnd())
    };

private static int
GetHashCodeWithoutTrailingWhitespace(string a) => a.TrimEnd().GetHashCode();
}
