...
public class KdbndpSqlGenerationHelper : RelationalSqlGenerationHelper {
  ...
  static KdbndpSqlGenerationHelper() {
    ...
    using (var conn = new KdbndpConnection()) {
      ReservedWords =
          new HashSet<string>(conn.GetSchema("ReservedWords")
                                  .Rows.Cast<DataRow>()
                                  .Select(r => (string)r["ReservedWord"]));
    }
  }
  ...
  /// </summary>
  public KdbndpSqlGenerationHelper(
  ...
  public override string DelimitIdentifier(string identifier) =>
      RequiresQuoting(identifier) ? base.DelimitIdentifier(identifier)
                                  : identifier;
  ...
  ///     when updating to a new Entity Framework Core release.
  /// </summary>
  public override void DelimitIdentifier(StringBuilder builder,
                                         string identifier) {
  ...
  /// <summary>
  ///     Returns whether the given string can be used as an unquoted identifier
  ///     in KingbaseES, without quotes.
  /// </summary>
