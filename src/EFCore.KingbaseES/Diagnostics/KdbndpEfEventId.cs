...
/// <summary>
///     <para>
///         Event IDs for KingbaseES/Kdbndp events that correspond to messages
///         logged to an <see cref="ILogger" /> and events sent to a <see
///         cref="DiagnosticSource" />.
///     </para>
///     <para>
///         These IDs are also used with <see
///         cref="WarningsConfigurationBuilder" /> to configure the behavior of
///         warnings.
///     </para>
/// </summary>
public static class KdbndpEfEventId {
  ...
  private static readonly string ScaffoldingPrefix =
      DbLoggerCategory.Scaffolding.Name + ".";

  private static EventId
  MakeScaffoldingId(Id id) => new((int)id, ScaffoldingPrefix + id);
  ...
  ///     </para>
  ///     <para>
  ///         This event is in the <see cref="DbLoggerCategory.Scaffolding" />
  ///         category.
  ///     </para>
  /// </summary>
  public static readonly EventId ColumnFound =
      MakeScaffoldingId(Id.ColumnFound);
  ...
  public static readonly EventId MissingSchemaWarning =
      MakeScaffoldingId(Id.MissingSchemaWarning);
  ...
  public static readonly EventId CollationFound =
      MakeScaffoldingId(Id.CollationFound);
  ...
  public static readonly EventId MissingTableWarning =
      MakeScaffoldingId(Id.MissingTableWarning);
  ...
  public static readonly EventId
      ForeignKeyReferencesMissingPrincipalTableWarning = MakeScaffoldingId(
          Id.ForeignKeyReferencesMissingPrincipalTableWarning);
  ...
  public static readonly EventId SequenceFound =
      MakeScaffoldingId(Id.SequenceFound);
  ...
  public static readonly EventId PrimaryKeyFound =
      MakeScaffoldingId(Id.PrimaryKeyFound);
  ...
  public static readonly EventId UniqueConstraintFound =
      MakeScaffoldingId(Id.UniqueConstraintFound);
  ...
  public static readonly EventId ForeignKeyFound =
      MakeScaffoldingId(Id.ForeignKeyFound);
  ...
  /// <summary>
  ///     <para>
  ///         Enum column cannot be scaffolded, define a CLR enum type and add
  ...
  public static readonly EventId EnumColumnSkippedWarning =
      MakeScaffoldingId(Id.EnumColumnSkippedWarning);

  /// <summary>
  ///     <para>
  ///         Expression index cannot be scaffolded, expression indices aren't
  ///         supported and must be added via raw SQL in migrations.
  ///     </para>
  ///     <para>
  ///         This event is in the <see cref="DbLoggerCategory.Scaffolding" />
  ///         category.
  ...
  public static readonly EventId ExpressionIndexSkippedWarning =
      MakeScaffoldingId(Id.ExpressionIndexSkippedWarning);

  /// <summary>
  ///     <para>
  ///         Index '{name}' on table {tableName} cannot be scaffolded because
  ///         it includes a column that cannot be scaffolded (e.g. enum).
  ///     </para>
  ///     <para>
  ///         This event is in the <see cref="DbLoggerCategory.Scaffolding" />
  ///         category.
  ...
  public static readonly EventId UnsupportedColumnIndexSkippedWarning =
      MakeScaffoldingId(Id.UnsupportedColumnIndexSkippedWarning);

  /// <summary>
  ///     <para>
  ///         Constraint '{name}' on table {tableName} cannot be scaffolded
  ///         because it includes a column that cannot be scaffolded (e.g.
  ///         enum).
  ///     </para>
  ///     <para>
  ///         This event is in the <see cref="DbLoggerCategory.Scaffolding" />
