...
/// </summary>
public class KdbndpParameterBasedSqlProcessor
  ...
  /// </summary>
  public override
      Expression Optimize(Expression queryExpression,
                          IReadOnlyDictionary<string, object?> parametersValues,
                          out bool canCache) {
    queryExpression =
        base.Optimize(queryExpression, parametersValues, out canCache);

    queryExpression =
        new KdbndpDeleteConvertingExpressionVisitor().Process(queryExpression);
  ...
  ProcessSqlNullability(Expression selectExpression,
                        IReadOnlyDictionary<string, object?> parametersValues,
                        out bool canCache) {
    Check.NotNull(selectExpression, nameof(selectExpression));
    Check.NotNull(parametersValues, nameof(parametersValues));

    return new KdbndpSqlNullabilityProcessor(Dependencies, UseRelationalNulls)
