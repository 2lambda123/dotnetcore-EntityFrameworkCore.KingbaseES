...
/// </summary>
public class KdbndpCompiledQueryCacheKeyGenerator
  ...
  private struct KdbndpCompiledQueryCacheKey {
    private readonly RelationalCompiledQueryCacheKey
        _relationalCompiledQueryCacheKey;
    ...
    public override bool Equals(object? obj) =>
        !(obj is null) && obj is KdbndpCompiledQueryCacheKey key && Equals(key);

    private bool Equals(KdbndpCompiledQueryCacheKey other) =>
        _relationalCompiledQueryCacheKey.Equals(
            other._relationalCompiledQueryCacheKey) &&
        _reverseNullOrdering == other._reverseNullOrdering;

    public override int
    GetHashCode() => HashCode.Combine(_relationalCompiledQueryCacheKey,
                                      _reverseNullOrdering);
  }
}
