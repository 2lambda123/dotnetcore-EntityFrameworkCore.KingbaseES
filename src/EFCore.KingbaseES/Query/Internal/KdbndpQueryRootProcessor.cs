...
public class KdbndpQueryRootProcessor : RelationalQueryRootProcessor {
  ...
  /// <summary>
  ///     Converts a <see cref="ParameterExpression" /> to a <see
  ///     cref="ParameterQueryRootExpression" />, to be later translated to
  ...
  protected override bool ShouldConvertToParameterQueryRoot(
      ParameterExpression parameterExpression) => _supportsUnnest;
}
