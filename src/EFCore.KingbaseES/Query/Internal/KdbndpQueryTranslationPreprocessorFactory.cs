...
/// </summary>
public class KdbndpQueryTranslationPreprocessorFactory
  ...
  Create(QueryCompilationContext queryCompilationContext) => new KdbndpQueryTranslationPreprocessor(
      Dependencies, RelationalDependencies, _KdbndpSingletonOptions,
