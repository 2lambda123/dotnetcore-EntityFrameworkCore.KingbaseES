...
/// </summary>
public class KdbndpQueryCompilationContextFactory
    : IQueryCompilationContextFactory {
  private readonly QueryCompilationContextDependencies _dependencies;
  private readonly RelationalQueryCompilationContextDependencies
  ...
  ///     when updating to a new Entity Framework Core release.
  /// </summary>
  public virtual QueryCompilationContext
  Create(bool async) => new KdbndpQueryCompilationContext(
      _dependencies, _relationalDependencies, async);
}
