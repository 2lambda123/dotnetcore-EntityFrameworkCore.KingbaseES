...
/// </summary>
public class KdbndpQueryTranslationPostprocessorFactory
  ...
  /// </summary>
  protected virtual RelationalQueryTranslationPostprocessorDependencies
      RelationalDependencies {
        get;
      }

  /// <inheritdoc />
  public virtual QueryTranslationPostprocessor
  Create(QueryCompilationContext queryCompilationContext) => new KdbndpQueryTranslationPostprocessor(
