...
/// </summary>
public class KdbndpParameterBasedSqlProcessorFactory
  ...
  ///     when updating to a new Entity Framework Core release.
  /// </summary>
  public virtual RelationalParameterBasedSqlProcessor
  Create(bool useRelationalNulls) => new KdbndpParameterBasedSqlProcessor(
      _dependencies, useRelationalNulls);
}
