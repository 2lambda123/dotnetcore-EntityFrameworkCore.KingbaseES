...
/// <summary>
///     Locates instances of <see cref="PgUnnestExpression" /> in the tree and
///     prunes the WITH ORDINALITY clause from them if the ordinality column
  ...
  public override Expression? Visit(Expression? expression) {
    ...
    case SelectExpression selectExpression: {
      ...
      for (var i = 0; i < selectExpression.Tables.Count; i++) {
        ...
        // Find any unnest table which does not have any references to its
        // ordinality column in the projection or orderings (this is where they
        // may appear when a column is an identifier).
        var unnest = table as PgUnnestExpression ??
                     (table as JoinExpressionBase)?.Table as PgUnnestExpression;
        if (unnest is not null &&
            !selectExpression.Orderings.Select(o => o.Expression)
                 ...
                 .Any(p => p is ColumnExpression {
                   Name : "ordinality",
                   Table : var ordinalityTable
          ...
          var newUnnest =
              new PgUnnestExpression(unnest.Alias, unnest.Array,
                                     unnest.ColumnName, withOrdinality: false);

          newTables[i] =
              table switch { JoinExpressionBase j => j.Update(newUnnest),
      ...
      return base.Visit(
          newTables is null
              ...
              : selectExpression.Update(
                    selectExpression.Projection, newTables,
                    selectExpression.Predicate, selectExpression.GroupBy,
                    selectExpression.Having, selectExpression.Orderings,
