...
/// </summary>
public class KdbndpQueryableMethodTranslatingExpressionVisitorFactory
  ...
  ///     when updating to a new Entity Framework Core release.
  /// </summary>
  public virtual QueryableMethodTranslatingExpressionVisitor
  Create(QueryCompilationContext queryCompilationContext) => new KdbndpQueryableMethodTranslatingExpressionVisitor(
