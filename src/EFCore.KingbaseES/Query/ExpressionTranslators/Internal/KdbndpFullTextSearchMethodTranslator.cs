...
public class KdbndpFullTextSearchMethodTranslator : IMethodCallTranslator {
  private static readonly MethodInfo TsQueryParse =
      typeof(KdbndpTsQuery)
          .GetMethod(nameof(KdbndpTsQuery.Parse),
                     BindingFlags.Public | BindingFlags.Static)!;

  private static readonly MethodInfo TsVectorParse =
      typeof(KdbndpTsVector)
          .GetMethod(nameof(KdbndpTsVector.Parse),
                     BindingFlags.Public | BindingFlags.Static)!;
  ...
  public KdbndpFullTextSearchMethodTranslator(
      ...
      KdbndpSqlExpressionFactory sqlExpressionFactory, IModel model) {
  ...
  public virtual SqlExpression? Translate(
    ...
    if (method.DeclaringType ==
        typeof(KdbndpFullTextSearchDbFunctionsExtensions)) {
    ...
    if (method.DeclaringType == typeof(KdbndpFullTextSearchLinqExtensions)) {
      if (method.Name is nameof(KdbndpFullTextSearchLinqExtensions.Rank)
              or nameof(KdbndpFullTextSearchLinqExtensions.RankCoverDensity)) {
        var rankFunctionName =
            method.Name == nameof(KdbndpFullTextSearchLinqExtensions.Rank)
                ? "ts_rank"
                : "ts_rank_cd";

        return arguments.Count switch {
          2 => _sqlExpressionFactory.Function(
              rankFunctionName, arguments, nullable: true,
              argumentsPropagateNullability: TrueArrays[2], typeof(float),
              _typeMappingSource.FindMapping(typeof(float), _model)),

          3 => _sqlExpressionFactory.Function(
              rankFunctionName,
              new[] { arguments[1].Type == typeof(float[]) ? arguments[1]
                                                           : arguments[0],
                      arguments[1].Type == typeof(float[]) ? arguments[0]
                                                           : arguments[1],
                      arguments[2] },
          ...
          4 => _sqlExpressionFactory.Function(
              ...
              nullable: true, argumentsPropagateNullability: TrueArrays[4],
              method.ReturnType,
              _typeMappingSource.FindMapping(typeof(float), _model)),
      ...
      if (method.Name == nameof(KdbndpFullTextSearchLinqExtensions.SetWeight)) {
        ...
        if (newArgs[1].Type == typeof(KdbndpTsVector.Lexeme.Weight)) {
          newArgs[1] =
              newArgs[1] is SqlConstantExpression weightExpression
                  ? _sqlExpressionFactory.Constant(
                        weightExpression.Value!.ToString()![0])
      ...
      return method.Name switch {
        ...
        nameof(KdbndpFullTextSearchLinqExtensions.And) =>
            _sqlExpressionFactory.MakePostgresBinary(
                PgExpressionType.TextSearchAnd, arguments[0], arguments[1]),
        nameof(KdbndpFullTextSearchLinqExtensions.Or) =>
            _sqlExpressionFactory.MakePostgresBinary(
                PgExpressionType.TextSearchOr, arguments[0], arguments[1]),

        nameof(KdbndpFullTextSearchLinqExtensions.ToNegative) =>
            new SqlUnaryExpression(ExpressionType.Not, arguments[0],
                                   arguments[0].Type, arguments[0].TypeMapping),
        ...
        nameof(KdbndpFullTextSearchLinqExtensions.Concat) =>
            _sqlExpressionFactory.Add(arguments[0], arguments[1],
                                      _tsVectorMapping),

        nameof(KdbndpFullTextSearchLinqExtensions.Matches) =>
            _sqlExpressionFactory.MakePostgresBinary(
                PgExpressionType.TextSearchMatch, arguments[0],
                arguments[1].Type == typeof(string)
                    ? _sqlExpressionFactory.Function(
                          "plainto_tsquery", new[] { arguments[1] },
                          nullable: true,
                          argumentsPropagateNullability: TrueArrays[1],
                          typeof(KdbndpTsQuery), _tsQueryMapping)
                    : arguments[1]),
        ...
        nameof(KdbndpFullTextSearchLinqExtensions.GetNodeCount) =>
            _sqlExpressionFactory.Function(
                "numnode", arguments, nullable: true,
        ...
        nameof(KdbndpFullTextSearchLinqExtensions.GetQueryTree) =>
            _sqlExpressionFactory.Function(
                "querytree", arguments, nullable: true,
                argumentsPropagateNullability: TrueArrays[1], typeof(string),
                _typeMappingSource.FindMapping(method.ReturnType, _model)),

        nameof(KdbndpFullTextSearchLinqExtensions.GetResultHeadline)
                when arguments.Count ==
            2 => _sqlExpressionFactory.Function(
            "ts_headline", new[] { arguments[1], arguments[0] }, nullable: true,
            argumentsPropagateNullability: TrueArrays[2], method.ReturnType),

        nameof(KdbndpFullTextSearchLinqExtensions.GetResultHeadline)
                when arguments.Count ==
            3 => _sqlExpressionFactory.Function(
            "ts_headline", new[] { arguments[1], arguments[0], arguments[2] },
            nullable: true, argumentsPropagateNullability: TrueArrays[3],
            method.ReturnType),
        ...
        nameof(KdbndpFullTextSearchLinqExtensions.GetResultHeadline)
            ...
            4 => _sqlExpressionFactory.Function(
            "ts_headline",
            new[] {// For the regconfig parameter, if a constant string was
                   // provided, just pass it as a string - regconfig-accepting
                   // functions will implicitly cast to regconfig. For (string!)
                   // parameters, we add an explicit cast, since regconfig
                   // actually is an OID behind the scenes, and for parameter
                   // binary transfer no type coercion occurs.
                   arguments[1] is SqlConstantExpression constant
                       ? _sqlExpressionFactory.ApplyDefaultTypeMapping(constant)
                       : _sqlExpressionFactory.Convert(
                             arguments[1], typeof(string), _regconfigMapping),
                   arguments[2], arguments[0], arguments[3]
            },
            nullable: true, argumentsPropagateNullability: TrueArrays[4],
            method.ReturnType),
        ...
        nameof(KdbndpFullTextSearchLinqExtensions.Rewrite)
                when arguments.Count ==
            2 => _sqlExpressionFactory.Function(
            "ts_rewrite", arguments, nullable: true,
            argumentsPropagateNullability: TrueArrays[2], typeof(KdbndpTsQuery),
            _tsQueryMapping),
        ...
        nameof(KdbndpFullTextSearchLinqExtensions.Rewrite)
            ...
            3 => _sqlExpressionFactory.Function(
            "ts_rewrite", arguments, nullable: true,
            argumentsPropagateNullability: TrueArrays[3], typeof(KdbndpTsQuery),
            _tsQueryMapping),

        nameof(KdbndpFullTextSearchLinqExtensions.ToPhrase) =>
            _sqlExpressionFactory.Function(
                "tsquery_phrase", arguments, nullable: true,
                argumentsPropagateNullability: TrueArrays[arguments.Count],
                typeof(KdbndpTsQuery), _tsQueryMapping),

        nameof(KdbndpFullTextSearchLinqExtensions.Delete) =>
            _sqlExpressionFactory.Function(
                "ts_delete", arguments, nullable: true,
                argumentsPropagateNullability: TrueArrays[2], method.ReturnType,
                _tsVectorMapping),

        // TODO: Here we need to cast the char[] array we got into a "char"[]
        // internal array...
        nameof(KdbndpFullTextSearchLinqExtensions.Filter) =>
            throw new NotImplementedException(),
        //=> _sqlExpressionFactory.Function("ts_filter", arguments,
        //typeof(KdbndpTsVector), _tsVectorMapping),

        nameof(KdbndpFullTextSearchLinqExtensions.GetLength) =>
            _sqlExpressionFactory.Function(
                "length", arguments, nullable: true,
        ...
        nameof(KdbndpFullTextSearchLinqExtensions.ToStripped) =>
            _sqlExpressionFactory.Function(
                "strip", arguments, nullable: true,
                argumentsPropagateNullability: TrueArrays[arguments.Count],
                method.ReturnType, _tsVectorMapping),
    ...
    SqlExpression
    ConfigAccepting(string functionName) => _sqlExpressionFactory.Function(
        functionName,
        new[] {
          // For the regconfig parameter, if a constant string was provided,
          // just pass it as a string - regconfig-accepting functions will
          // implicitly cast to regconfig. For (string!) parameters, we add an
          // explicit cast, since regconfig actually is an OID behind the
          // scenes, and for parameter binary transfer no type coercion occurs.
          arguments[1] is SqlConstantExpression constant
              ? _sqlExpressionFactory.ApplyDefaultTypeMapping(constant)
    ...
    SqlExpression
    DictionaryAccepting(string functionName) => _sqlExpressionFactory.Function(
        functionName,
        new[] {
          // For the regdictionary parameter, if a constant string was provided,
          // just pass it as a string - regdictionary-accepting functions will
          // implicitly cast to regdictionary. For (string!) parameters, we add
          // an explicit cast, since regdictionary actually is an OID behind the
          // scenes, and for parameter binary transfer no type coercion occurs.
          arguments[1] is SqlConstantExpression constant
              ? _sqlExpressionFactory.ApplyDefaultTypeMapping(constant)
              : _sqlExpressionFactory.Convert(arguments[1], typeof(string),
                                              _regdictionaryMapping),
          arguments[2]
        },
        nullable: true,
        argumentsPropagateNullability: TrueArrays[arguments.Count],
    ...
    SqlExpression NonConfigAccepting(string functionName) =>
        _sqlExpressionFactory.Function(
            functionName, new[] { arguments[1] }, nullable: true,
            argumentsPropagateNullability: TrueArrays[arguments.Count],
            method.ReturnType,
            _typeMappingSource.FindMapping(method.ReturnType, _model));
  }
