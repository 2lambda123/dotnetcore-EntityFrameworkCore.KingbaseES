...
/// </summary>
public class KdbndpMethodCallTranslatorProvider
  ...
  public KdbndpMethodCallTranslatorProvider(
      ...
      IModel model, IDbContextOptions contextOptions)
      : base(dependencies) {
    var KdbndpOptions =
        contextOptions.FindExtension<KdbndpOptionsExtension>() ??
    ...
    var typeMappingSource =
        (KdbndpTypeMappingSource)dependencies.RelationalTypeMappingSource;
    var jsonTranslator = new KdbndpJsonPocoTranslator(
        typeMappingSource, sqlExpressionFactory, model);
    LTreeTranslator = new KdbndpLTreeTranslator(typeMappingSource,
    ...
    AddTranslators(new IMethodCallTranslator[] {
      ...
      new KdbndpDateTimeMethodTranslator(typeMappingSource,
                                         sqlExpressionFactory),
      new KdbndpFullTextSearchMethodTranslator(typeMappingSource,
                                               sqlExpressionFactory, model),
      new KdbndpFuzzyStringMatchMethodTranslator(sqlExpressionFactory),
      new KdbndpJsonDomTranslator(typeMappingSource, sqlExpressionFactory,
                                  model),
      new KdbndpJsonDbFunctionsTranslator(typeMappingSource,
                                          sqlExpressionFactory, model),
      new KdbndpJsonPocoTranslator(typeMappingSource, sqlExpressionFactory,
                                   model),
      new KdbndpLikeTranslator(sqlExpressionFactory),
      LTreeTranslator,
      new KdbndpMathTranslator(typeMappingSource, sqlExpressionFactory, model),
      new KdbndpNetworkTranslator(typeMappingSource, sqlExpressionFactory,
                                  model),
      new KdbndpNewGuidTranslator(sqlExpressionFactory,
                                  KdbndpOptions.PostgresVersion),
      new KdbndpObjectToStringTranslator(typeMappingSource,
                                         sqlExpressionFactory),
      new KdbndpRandomTranslator(sqlExpressionFactory),
      new KdbndpRangeTranslator(typeMappingSource, sqlExpressionFactory, model,
                                supportsMultiranges),
      ...
      new KdbndpTrigramsMethodTranslator(typeMappingSource,
                                         sqlExpressionFactory, model),
    });
  }
}
