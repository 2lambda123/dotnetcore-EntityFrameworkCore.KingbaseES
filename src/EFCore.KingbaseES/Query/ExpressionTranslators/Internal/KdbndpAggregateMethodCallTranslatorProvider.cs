...
/// </summary>
public class KdbndpAggregateMethodCallTranslatorProvider
  ...
  public KdbndpAggregateMethodCallTranslatorProvider(
    ...
    AddTranslators(new IAggregateMethodCallTranslator[] {
      new KdbndpQueryableAggregateMethodTranslator(sqlExpressionFactory,
                                                   typeMappingSource),
      new KdbndpStatisticsAggregateMethodTranslator(sqlExpressionFactory,
                                                    typeMappingSource),
      new KdbndpMiscAggregateMethodTranslator(sqlExpressionFactory,
                                              typeMappingSource, model)
    });
  }
}
