...
/// </summary>
public class KdbndpQueryableAggregateMethodTranslator
    ...
    if (method.DeclaringType == typeof(Queryable)) {
      ...
      case nameof(Queryable.Average)
        ...
        if (averageInputType == typeof(int) ||
          ...
          averageSqlExpression = _sqlExpressionFactory.ApplyDefaultTypeMapping(
              _sqlExpressionFactory.Convert(averageSqlExpression,
                                            typeof(double)));
        }
        ...
        return averageInputType == typeof(float)
                   ? _sqlExpressionFactory.Convert(
                         _sqlExpressionFactory.AggregateFunction(
                             "avg", new[] { averageSqlExpression }, source,
                             nullable: true,
      ...
      case nameof(Queryable.Count)
        ...
        return _sqlExpressionFactory.Convert(
            _sqlExpressionFactory.AggregateFunction(
                "count", new[] { countSqlExpression }, source, nullable: false,
                argumentsPropagateNullability: FalseArrays[1], typeof(long)),
            typeof(int), _typeMappingSource.FindMapping(typeof(int)));

      case nameof(Queryable.LongCount) when methodInfo ==
        ...
        return _sqlExpressionFactory.AggregateFunction(
            "count", new[] { longCountSqlExpression }, source, nullable: false,
            argumentsPropagateNullability: FalseArrays[1], typeof(long));
      ...
      case nameof(Queryable.Max)
        ...
        return _sqlExpressionFactory.AggregateFunction(
            "max", new[] { maxSqlExpression }, source, nullable: true,
            argumentsPropagateNullability: FalseArrays[1],
            maxSqlExpression.Type, maxSqlExpression.TypeMapping);
      ...
      case nameof(Queryable.Min)
        ...
        return _sqlExpressionFactory.AggregateFunction(
            "min", new[] { minSqlExpression }, source, nullable: true,
            argumentsPropagateNullability: FalseArrays[1],
            minSqlExpression.Type, minSqlExpression.TypeMapping);

      // In KingbaseES SUM() doesn't return the same type as its argument for
      // smallint, int and bigint. Cast to get the same type.
      ...
      case nameof(Queryable.Sum)
        ...
        if (sumInputType == typeof(int)) {
          return _sqlExpressionFactory.Convert(
              _sqlExpressionFactory.AggregateFunction(
                  "sum", new[] { sumSqlExpression }, source, nullable: true,
                  argumentsPropagateNullability: FalseArrays[1], typeof(long)),
              sumInputType, sumSqlExpression.TypeMapping);
        }
        ...
        return _sqlExpressionFactory.AggregateFunction(
            "sum", new[] { sumSqlExpression }, source, nullable: true,
            argumentsPropagateNullability: FalseArrays[1], sumInputType,
