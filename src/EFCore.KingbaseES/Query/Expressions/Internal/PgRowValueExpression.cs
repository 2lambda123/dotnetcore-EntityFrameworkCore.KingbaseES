...
/// <summary>
///     An expression that represents a KingbaseES-specific row value expression
///     in a SQL tree.
/// </summary>
/// <remarks>
///     See the <see
///     href="https://www.KingbaseES.org/docs/current/sql-expressions.html#SQL-SYNTAX-ROW-CONSTRUCTORS">KingbaseES
///     docs</see> for more information.
/// </remarks>
public class PgRowValueExpression : SqlExpression,
                                    IEquatable<PgRowValueExpression> {
  /// <summary>
  ...
  /// <inheritdoc />
  public PgRowValueExpression(IReadOnlyList<SqlExpression> values, Type type,
                              RelationalTypeMapping? typeMapping = null)
      : base(type, typeMapping) {
    Check.NotNull(values, nameof(values));
    Check.DebugAssert(type.IsAssignableTo(typeof(ITuple)),
                      $"Type '{type}' isn't an ITuple");
  ...
  protected override Expression VisitChildren(ExpressionVisitor visitor) {
    ...
    return newRowValues is null ? this
                                : new PgRowValueExpression(newRowValues, Type);
  }
  ...
  /// <inheritdoc />
  public override bool Equals(object? obj) => obj is PgRowValueExpression other
                                              && Equals(other);
