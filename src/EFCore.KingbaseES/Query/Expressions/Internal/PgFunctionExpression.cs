...
/// <summary>
///     Represents a SQL function call expression, supporting KingbaseES's named
///     parameter notation (e.g. make_interval(weeks => 2) and non-comma
///     parameter separators (e.g. position(substring in string)).
/// </summary>
[DebuggerDisplay("{" + nameof(ToString) + "()}")]
public class PgFunctionExpression : SqlFunctionExpression,
                                    IEquatable<PgFunctionExpression> {
  /// <inheritdoc />
  public new virtual IReadOnlyList<SqlExpression> Arguments => base.Arguments!;

  /// <inheritdoc />
  public new virtual IReadOnlyList<bool>
      ArgumentsPropagateNullability => base.ArgumentsPropagateNullability!;
  ...
  /// <summary>
  ///     For aggregate methods, contains the predicate to be applied (generated
  ///     as the SQL FILTER clause).
  /// </summary>
  ...
  /// <summary>
  ///     List of argument names, corresponding position-wise to arguments in
  ///     <see cref="SqlFunctionExpression.Arguments" />. Unnamed (positional)
  ///     arguments must come first, so this list must contain possible nulls,
  ///     followed by non-nulls.
  /// </summary>
  public virtual IReadOnlyList<string?> ArgumentNames { get; }

  /// <summary>
  ///     List of non-comma separators between argument separators, in the order
  ///     in which they appear between the arguments. <c>null</c> as well as
  ///     positions beyond the end of the list mean regular commas.
  /// </summary>
  public virtual IReadOnlyList<string?> ArgumentSeparators { get; }

  /// <summary>
  ///     Creates an instance of <see cref="PgFunctionExpression" /> with named
  ///     arguments.
  /// </summary>
  public static PgFunctionExpression
  CreateWithNamedArguments(string name, IEnumerable<SqlExpression> arguments,
                           IEnumerable<string?> argumentNames, bool nullable,
                           IEnumerable<bool> argumentsPropagateNullability,
                           bool builtIn, Type type,
    ...
    return new PgFunctionExpression(
        ...
        aggregateDistinct: false, aggregatePredicate: null,
        aggregateOrderings: Array.Empty<OrderingExpression>(),
        nullable: nullable,
        argumentsPropagateNullability: argumentsPropagateNullability,
        type: type, typeMapping: typeMapping);
  }

  /// <summary>
  ///     Creates an instance of <see cref="PgFunctionExpression" /> with
  ///     argument separators.
  /// </summary>
  public static PgFunctionExpression CreateWithArgumentSeparators(
      string name, IEnumerable<SqlExpression> arguments,
      IEnumerable<string?> argumentSeparators, bool nullable,
      IEnumerable<bool> argumentsPropagateNullability, bool builtIn, Type type,
      RelationalTypeMapping? typeMapping) {
    Check.NotNull(arguments, nameof(arguments));
    Check.NotNull(argumentSeparators, nameof(argumentSeparators));

    return new PgFunctionExpression(
        name, arguments, argumentNames: null,
        argumentSeparators: argumentSeparators, aggregateDistinct: false,
  ...
  public PgFunctionExpression(
      ...
      IEnumerable<string?>? argumentSeparators, bool aggregateDistinct,
      SqlExpression? aggregatePredicate,
      IReadOnlyList<OrderingExpression> aggregateOrderings, bool nullable,
      IEnumerable<bool> argumentsPropagateNullability, Type type,
      RelationalTypeMapping? typeMapping)
      : base(name, arguments, nullable, argumentsPropagateNullability, type,
             typeMapping) {
    ...
    if (ArgumentNames.SkipWhile(a => a is null).Contains(null)) {
      throw new ArgumentException(
          $"{nameof(argumentNames)} must contain nulls followed by non-nulls",
  ...
  protected override Expression VisitChildren(ExpressionVisitor visitor) {
    ...
    var visitedAggregatePredicate =
        (SqlExpression?)visitor.Visit(AggregatePredicate);
    ...
    for (var i = 0; i < AggregateOrderings.Count; i++) {
      var visitedOrdering =
          (OrderingExpression)visitor.Visit(AggregateOrderings[i]);
      if (visitedOrdering != AggregateOrderings[i] &&
          visitedAggregateOrderings is null) {
        changed = true;
        visitedAggregateOrderings =
            new OrderingExpression[AggregateOrderings.Count];
    ...
    return changed ? new PgFunctionExpression(
                         Name, visitedArguments ?? Arguments, ArgumentNames,
                         ArgumentSeparators, IsAggregateDistinct,
                         visitedAggregatePredicate ?? AggregatePredicate,
                         visitedAggregateOrderings ?? AggregateOrderings,
                         IsNullable, ArgumentsPropagateNullability!, Type,
                         TypeMapping)
                   : this;
  }

  /// <inheritdoc />
  public override SqlFunctionExpression
      ApplyTypeMapping(RelationalTypeMapping? typeMapping) =>
          new PgFunctionExpression(Name, Arguments, ArgumentNames,
                                   ArgumentSeparators, IsAggregateDistinct,
                                   AggregatePredicate, AggregateOrderings,
                                   IsNullable, ArgumentsPropagateNullability,
                                   Type, typeMapping ?? TypeMapping);

  /// <inheritdoc />
  public override SqlFunctionExpression
  Update(SqlExpression? instance, IReadOnlyList<SqlExpression>? arguments) {
    Check.NotNull(arguments, nameof(arguments));
    ...
    return !arguments.SequenceEqual(Arguments)
               ? new PgFunctionExpression(
                     ...
                     AggregateOrderings, IsNullable,
                     ArgumentsPropagateNullability, Type, TypeMapping)
               : this;
  }
  ...
  public virtual PgFunctionExpression UpdateAggregateComponents(
      ...
      IReadOnlyList<OrderingExpression>
          orderings) => predicate != AggregatePredicate
                                || orderings != AggregateOrderings
                            ? new PgFunctionExpression(
                                  Name, Arguments, ArgumentNames,
                                  ArgumentSeparators, IsAggregateDistinct,
                                  predicate, orderings, IsNullable,
                                  ArgumentsPropagateNullability, Type,
                                  TypeMapping)
                            : this;
  ...
  public override bool
      Equals(object? obj) => obj is PgFunctionExpression pgFunction &&
                             Equals(pgFunction);

  /// <inheritdoc />
  public virtual bool Equals(
      PgFunctionExpression? other) => ReferenceEquals(this, other) ||
                                      other is not null && base.Equals(other) &&
                                          ArgumentNames.SequenceEqual(
                                              other.ArgumentNames) &&
                                          ArgumentSeparators.SequenceEqual(
                                              other.ArgumentSeparators) &&
                                          AggregateOrderings.SequenceEqual(
                                              other.AggregateOrderings) &&
                                          (AggregatePredicate is null &&
                                               other.AggregatePredicate is
                                                   null ||
                                           AggregatePredicate != null &&
                                               AggregatePredicate.Equals(
                                                   other.AggregatePredicate));
