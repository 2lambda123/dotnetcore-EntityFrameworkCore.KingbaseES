...
public sealed class PgDeleteExpression : Expression, IPrintableExpression {
  ...
  /// </summary>
  public PgDeleteExpression(TableExpression table,
                            IReadOnlyList<TableExpressionBase> fromItems,
                            SqlExpression? predicate, ISet<string> tags) {
  ...
  ///     expression.
  /// </summary>
  /// <param name="predicate">The <see cref="Predicate" /> property of the
  /// result.</param>
  ...
  private bool Equals(PgDeleteExpression pgDeleteExpression) =>
      ...
      (Predicate is null ? pgDeleteExpression.Predicate is null
                         : Predicate.Equals(pgDeleteExpression.Predicate));
