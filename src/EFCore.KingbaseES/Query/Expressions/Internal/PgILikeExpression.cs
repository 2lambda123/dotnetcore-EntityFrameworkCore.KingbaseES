...
public class PgILikeExpression : SqlExpression, IEquatable<PgILikeExpression> {
  ...
  /// <param name="escapeChar">The escape character to use in <paramref
  /// name="pattern" />.</param> <param name="typeMapping">The <see
  /// cref="RelationalTypeMapping" /> associated with the expression.</param>
  /// <exception cref="ArgumentNullException" />
  public PgILikeExpression(SqlExpression match, SqlExpression pattern,
  ...
  /// <inheritdoc />
  protected override
      Expression VisitChildren(ExpressionVisitor visitor) => Update(
  ...
  Update(SqlExpression match, SqlExpression pattern,
         SqlExpression? escapeChar) => match == Match && pattern == Pattern
                                               && escapeChar == EscapeChar
                                           ? this
                                           : new PgILikeExpression(match,
                                                                   pattern,
                                                                   escapeChar,
                                                                   TypeMapping);

  /// <inheritdoc />
  public override bool Equals(object? obj) => obj is PgILikeExpression other &&
                                              Equals(other);

  /// <inheritdoc />
  public virtual bool Equals(
      PgILikeExpression? other) => ReferenceEquals(this, other) ||
