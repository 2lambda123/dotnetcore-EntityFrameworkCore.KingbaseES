...
public class PgAllExpression : SqlExpression, IEquatable<PgAllExpression> {
  ...
  public PgAllExpression(SqlExpression item, SqlExpression array,
  ...
  Update(SqlExpression item,
         SqlExpression array) => item != Item || array != Array
                                     ? new PgAllExpression(item, array,
                                                           OperatorType,
                                                           TypeMapping)
                                     : this;
  ...
  /// <inheritdoc />
  public override bool Equals(object? obj) => obj is PgAllExpression e &&
                                              Equals(e);

  /// <inheritdoc />
  public virtual bool Equals(
      PgAllExpression? other) => ReferenceEquals(this, other) ||
