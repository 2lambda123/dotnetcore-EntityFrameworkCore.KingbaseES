...
/// <summary>
///     A SQL expression that represents a slicing into a KingbaseES array (e.g.
///     array[2:3]).
/// </summary>
/// <remarks>
///     <see
///     href="https://www.KingbaseES.org/docs/current/arrays.html#ARRAYS-ACCESSING"
///     />.
/// </remarks>
public class PgArraySliceExpression : SqlExpression,
                                      IEquatable<PgArraySliceExpression> {
  /// <summary>
  ...
  /// <summary>
  ///     Creates a new instance of the <see cref="PgArraySliceExpression" />
  ///     class.
  /// </summary>
  ...
  public PgArraySliceExpression(SqlExpression array, SqlExpression? lowerBound,
                                SqlExpression? upperBound, bool nullable,
  ...
  /// result.</param> <param name="lowerBound">The lower bound of the
  /// slice.</param> <param name="upperBound">The upper bound of the
  /// slice.</param> <returns>This expression if no children changed, or an
  /// expression with the updated children.</returns>
  public virtual PgArraySliceExpression
  Update(SqlExpression array, SqlExpression? lowerBound,
         SqlExpression? upperBound) => array == Array
                                               && lowerBound == LowerBound
                                               && upperBound == UpperBound
                                           ? this
                                           : new PgArraySliceExpression(
                                                 array, lowerBound, upperBound,
                                                 IsNullable, Type, TypeMapping);
  ...
  public virtual bool Equals(
      PgArraySliceExpression? other) => ReferenceEquals(this, other) ||
                                        other is not null
                                            && base.Equals(other) &&
  ...
  /// <inheritdoc />
  public override bool Equals(object? obj) => obj is PgArraySliceExpression e &&
                                              Equals(e);
