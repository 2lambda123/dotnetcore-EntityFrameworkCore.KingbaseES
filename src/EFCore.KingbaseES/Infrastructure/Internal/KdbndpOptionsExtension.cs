...
public class KdbndpOptionsExtension : RelationalOptionsExtension {
  ...
  /// </summary>
  public virtual Version PostgresVersion => _postgresVersion ??
                                            DefaultPostgresVersion;

  /// <summary>
  ///     The backend version to target, but returns <see langword="null" />
  ///     unless the user explicitly specified a version.
  /// </summary>
  public virtual bool IsPostgresVersionSet => _postgresVersion is not null;

  /// <summary>
  ///     The <see cref="DbDataSource" />, or <see langword="null" /> if a
  ///     connection string or <see cref="DbConnection" /> was used instead of a
  ...
  /// </summary>
  public virtual IReadOnlyList<UserRangeDefinition>
      UserRangeDefinitions => _userRangeDefinitions;
  ...
  /// <summary>
  ///     Initializes an instance of <see cref="KdbndpOptionsExtension" /> with
  ...
  /// <summary>
  ///     Initializes an instance of <see cref="KdbndpOptionsExtension" /> by
  ///     copying the specified instance.
  /// </summary>
  ...
  public KdbndpOptionsExtension(KdbndpOptionsExtension copyFrom)
    ...
    _userRangeDefinitions =
        new List<UserRangeDefinition>(copyFrom._userRangeDefinitions);
    ProvideClientCertificatesCallback =
        copyFrom.ProvideClientCertificatesCallback;
    RemoteCertificateValidationCallback =
        copyFrom.RemoteCertificateValidationCallback;
    ReverseNullOrdering = copyFrom.ReverseNullOrdering;
  }

  // The following is a hack to set the default minimum batch size to 2 in
  // Kdbndp See https://github.com/aspnet/EntityFrameworkCore/pull/10091
  /// <summary>
  ///     This is an internal API that supports the Entity Framework Core
  ///     infrastructure and not subject to the same compatibility standards as
  ///     public APIs. It may be changed or removed without notice in any
  ...
  /// <summary>
  ///     Creates a new instance with all options the same as for this instance,
  ///     but with the given option changed. It is unusual to call this method
  ///     directly. Instead use <see cref="DbContextOptionsBuilder" />.
  /// </summary>
  /// <param name="dataSource">The option to change.</param>
  /// <returns>A new instance with the option changed.</returns>
  public virtual RelationalOptionsExtension
  WithDataSource(DbDataSource? dataSource) {
  ...
  /// <inheritdoc />
  public override RelationalOptionsExtension
  WithConnectionString(string? connectionString) {
    var clone =
        (KdbndpOptionsExtension)base.WithConnectionString(connectionString);
  ...
  /// <inheritdoc />
  public override
      RelationalOptionsExtension WithConnection(DbConnection? connection) {
  ...
  /// <summary>
  ///     Returns a copy of the current instance configured with the specified
  ///     range mapping.
  /// </summary>
  public virtual KdbndpOptionsExtension WithUserRangeDefinition<TSubtype>(
      string rangeName, string? schemaName = null,
      string? subtypeName = null) => WithUserRangeDefinition(rangeName,
                                                             schemaName,
                                                             typeof(TSubtype),
                                                             subtypeName);
  ...
  ///     range mapping.
  /// </summary>
  public virtual KdbndpOptionsExtension
  WithUserRangeDefinition(string rangeName, string? schemaName,
                          Type subtypeClrType, string? subtypeName) {
    Check.NotEmpty(rangeName, nameof(rangeName));
    Check.NotNull(subtypeClrType, nameof(subtypeClrType));

    var clone = (KdbndpOptionsExtension)Clone();

    clone._userRangeDefinitions.Add(new UserRangeDefinition(
        rangeName, schemaName, subtypeClrType, subtypeName));
  ...
  /// </summary>
  /// <param name="adminDatabase">The name of the database for administrative
  /// operations.</param>
  public virtual KdbndpOptionsExtension
  WithAdminDatabase(string? adminDatabase) {
    var clone = (KdbndpOptionsExtension)Clone();
  ...
  /// <summary>
  ///     Returns a copy of the current instance with the specified KingbaseES
  ///     version.
  /// </summary>
  ...
  /// </returns>
  public virtual KdbndpOptionsExtension
  WithPostgresVersion(Version? postgresVersion) {
    var clone = (KdbndpOptionsExtension)Clone();
  ...
  /// <summary>
  ///     Returns a copy of the current instance with the specified Redshift
  ///     settings.
  /// </summary>
  ...
  ///     value..
  /// </summary>
  /// <param name="reverseNullOrdering">True to enable reverse null ordering;
  /// otherwise, false.</param>
  internal virtual KdbndpOptionsExtension
  WithReverseNullOrdering(bool reverseNullOrdering) {
    var clone = (KdbndpOptionsExtension)Clone();
  ...
  public override void Validate(IDbContextOptions options) {
    ...
    if (UseRedshift && _postgresVersion is not null) {
      throw new InvalidOperationException(
          $"{nameof(UseRedshift)} and {nameof(PostgresVersion)} cannot both be set");
    }
  }
...
#region Authentication
  ...
  /// <summary>
  ///     Returns a copy of the current instance with the specified <see
  ///     cref="ProvideClientCertificatesCallback" />.
  /// </summary>
  /// <param name="callback">The specified callback.</param>
  public virtual KdbndpOptionsExtension WithProvideClientCertificatesCallback(
  ...
  /// <summary>
  ///     Returns a copy of the current instance with the specified <see
  ///     cref="RemoteCertificateValidationCallback" />.
  /// </summary>
  /// <param name="callback">The specified callback.</param>
  public virtual KdbndpOptionsExtension WithRemoteCertificateValidationCallback(
...
#region Infrastructure
  ...
  /// <inheritdoc />
  protected override
      RelationalOptionsExtension Clone() => new KdbndpOptionsExtension(this);
  ...
  private sealed class ExtensionInfo : RelationalExtensionInfo {
    ...
    public override string LogFragment {
      get {
        ...
        if (Extension.AdminDatabase is not null) {
          builder.Append(nameof(Extension.AdminDatabase))
              .Append("=")
              .Append(Extension.AdminDatabase)
              .Append(' ');
        }

        if (Extension._postgresVersion is not null) {
          builder.Append(nameof(Extension.PostgresVersion))
              .Append("=")
              .Append(Extension.PostgresVersion)
              .Append(' ');
        }
        ...
        if (Extension.RemoteCertificateValidationCallback is not null) {
          builder.Append(nameof(Extension.RemoteCertificateValidationCallback))
              .Append(" ");
        }
    ...
    ShouldUseSameServiceProvider(DbContextOptionsExtensionInfo other) =>
        ...
        &&
        Extension.UserRangeDefinitions.SequenceEqual(
            otherInfo.Extension.UserRangeDefinitions) &&
        Extension.UseRedshift == otherInfo.Extension.UseRedshift;

    /// <inheritdoc />
    public override void
    PopulateDebugInfo(IDictionary<string, string> debugInfo) {
      debugInfo["Kdbndp.EntityFrameworkCore.KingbaseES:" +
                nameof(KdbndpDbContextOptionsBuilder.UseAdminDatabase)] =
          (Extension.AdminDatabase?.GetHashCode() ?? 0)
              .ToString(CultureInfo.InvariantCulture);

      debugInfo["Kdbndp.EntityFrameworkCore.KingbaseES:" +
                nameof(KdbndpDbContextOptionsBuilder.SetPostgresVersion)] =
          Extension.PostgresVersion.GetHashCode().ToString(
              CultureInfo.InvariantCulture);

      debugInfo["Kdbndp.EntityFrameworkCore.KingbaseES:" +
                nameof(KdbndpDbContextOptionsBuilder.UseRedshift)] =
          Extension.UseRedshift.GetHashCode().ToString(
              CultureInfo.InvariantCulture);

      debugInfo["Kdbndp.EntityFrameworkCore.KingbaseES:" +
                nameof(KdbndpDbContextOptionsBuilder.ReverseNullOrdering)] =
          Extension.ReverseNullOrdering.GetHashCode().ToString(
              CultureInfo.InvariantCulture);

      debugInfo["Kdbndp.EntityFrameworkCore.KingbaseES:" +
                nameof(KdbndpDbContextOptionsBuilder
                           .RemoteCertificateValidationCallback)] =
          (Extension.RemoteCertificateValidationCallback?.GetHashCode() ?? 0)
              .ToString(CultureInfo.InvariantCulture);

      debugInfo["Kdbndp.EntityFrameworkCore.KingbaseES:" +
                nameof(KdbndpDbContextOptionsBuilder
                           .ProvideClientCertificatesCallback)] =
          (Extension.ProvideClientCertificatesCallback?.GetHashCode() ?? 0)
              .ToString(CultureInfo.InvariantCulture);
      ...
      foreach (var rangeDefinition in Extension._userRangeDefinitions) {
        debugInfo["Kdbndp.EntityFrameworkCore.KingbaseES:" +
            ...
            rangeDefinition.GetHashCode().ToString(
                CultureInfo.InvariantCulture);
      }
    }
  }
...
public record UserRangeDefinition {
  ...
  /// <summary>
  ///     The KingbaseES schema in which the range is defined. If null, the
  ///     default schema is used (which is public unless changed on the model).
  /// </summary>
  public virtual string ? SchemaName { get; }

  /// <summary>
  ///     The CLR type of the range's subtype (or element).
  ///     The actual mapped type will be an <see cref="KdbndpRange{T}" /> over
  ///     this type.
  /// </summary>
