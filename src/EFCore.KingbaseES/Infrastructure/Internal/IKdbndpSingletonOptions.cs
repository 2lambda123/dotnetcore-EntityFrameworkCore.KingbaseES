...
/// <summary>
///     Represents options for Kdbndp that can only be set at the <see
///     cref="IServiceProvider" /> singleton level.
/// </summary>
public interface IKdbndpSingletonOptions : ISingletonOptions {
  ...
  /// <summary>
  ///     The data source being used, or <see langword="null" /> if a connection
  ///     string or connection was provided directly.
  /// </summary>
