...
public class KdbndpValueGeneratorSelector : RelationalValueGeneratorSelector {
  ...
  /// </summary>
  public new virtual IKdbndpValueGeneratorCache
      Cache => (IKdbndpValueGeneratorCache)base.Cache;
  ...
  public override ValueGenerator Select(IProperty property,
      ...
      property.GetValueGeneratorFactory() is null
          ...
          ? _sequenceFactory.Create(
                property, Cache.GetOrAddSequenceState(property, _connection),
                _connection, _rawSqlCommandBuilder, _commandLogger)
  ...
  ///     when updating to a new Entity Framework Core release.
  /// </summary>
  protected override ValueGenerator? FindForType(IProperty property,
                                                 ITypeBase typeBase,
                                                 Type clrType) =>
