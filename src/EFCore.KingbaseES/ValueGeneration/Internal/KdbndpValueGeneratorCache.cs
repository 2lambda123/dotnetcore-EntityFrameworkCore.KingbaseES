...
/// </summary>
public class KdbndpValueGeneratorCache : ValueGeneratorCache,
                                         IKdbndpValueGeneratorCache {
  private readonly ConcurrentDictionary<
      string, KdbndpSequenceValueGeneratorState> _sequenceGeneratorCache =
      new();

  /// <summary>
  ///     Initializes a new instance of the <see cref="ValueGeneratorCache" />
  ///     class.
  /// </summary>
  ...
  ///     removed in future releases.
  /// </summary>
  public virtual KdbndpSequenceValueGeneratorState
  GetOrAddSequenceState(IProperty property, IRelationalConnection connection) {
