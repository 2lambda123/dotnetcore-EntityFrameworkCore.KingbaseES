...
/// </summary>
public class KdbndpSequenceValueGeneratorFactory
    : IKdbndpSequenceValueGeneratorFactory {
  ...
  ///     removed in future releases.
  /// </summary>
  public KdbndpSequenceValueGeneratorFactory(IUpdateSqlGenerator sqlGenerator) {
  ...
  ///     removed in future releases.
  /// </summary>
  public virtual ValueGenerator
  Create(IProperty property, KdbndpSequenceValueGeneratorState generatorState,
    ...
    if (type == typeof(long)) {
      return new KdbndpSequenceHiLoValueGenerator<long>(
          rawSqlCommandBuilder, _sqlGenerator, generatorState, connection,
          commandLogger);
    }
    ...
    throw new ArgumentException(
        CoreStrings.InvalidValueGeneratorFactoryProperty(
            nameof(KdbndpSequenceValueGeneratorFactory), property.Name,
