...
/// </summary>
public class KdbndpModificationCommandBatchFactory
  ...
  public KdbndpModificationCommandBatchFactory(
    ...
    _maxBatchSize =
        options.FindExtension<KdbndpOptionsExtension>()?.MaxBatchSize ??
        DefaultMaxBatchSize;
  ...
  ///     when updating to a new Entity Framework Core release.
  /// </summary>
  public virtual ModificationCommandBatch
  Create() => new KdbndpModificationCommandBatch(_dependencies, _maxBatchSize);
}
