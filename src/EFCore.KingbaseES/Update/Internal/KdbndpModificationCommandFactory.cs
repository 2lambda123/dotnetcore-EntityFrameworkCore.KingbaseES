...
public class KdbndpModificationCommandFactory : IModificationCommandFactory {
  ...
  public virtual IModificationCommand CreateModificationCommand(
      in ModificationCommandParameters
          modificationCommandParameters) => new KdbndpModificationCommand(modificationCommandParameters);
  ...
  ///     when updating to a new Entity Framework Core release.
  /// </summary>
  public virtual INonTrackedModificationCommand
  CreateNonTrackedModificationCommand(
      in NonTrackedModificationCommandParameters
          modificationCommandParameters) => new KdbndpModificationCommand(modificationCommandParameters);
}
