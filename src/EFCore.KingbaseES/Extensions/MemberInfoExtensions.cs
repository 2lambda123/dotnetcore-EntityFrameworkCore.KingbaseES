...
internal static class EntityFrameworkMemberInfoExtensions {
  ...
  public static bool IsSameAs(this MemberInfo? propertyInfo,
             ...
             (Equals(propertyInfo, otherPropertyInfo) ||
              (propertyInfo.Name == otherPropertyInfo.Name &&
               ...
               (propertyInfo.DeclaringType == otherPropertyInfo.DeclaringType ||
                propertyInfo.DeclaringType.GetTypeInfo().IsSubclassOf(
                    otherPropertyInfo.DeclaringType) ||
                otherPropertyInfo.DeclaringType.GetTypeInfo().IsSubclassOf(
