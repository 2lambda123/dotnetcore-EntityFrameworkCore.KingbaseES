...
public static class KdbndpMigrationBuilderExtensions {
  /// <summary>
  ///     Returns true if the active provider in a migration is the Kdbndp
  ///     provider.
  /// </summary>
  ...
  public static bool IsKdbndp(this MigrationBuilder builder) =>
      builder.ActiveProvider == typeof(KdbndpMigrationBuilderExtensions)
                                    .GetTypeInfo()
                                    .Assembly.GetName()
                                    .Name;
  ...
  /// </summary>
  public static MigrationBuilder
  EnsurePostgresExtension(this MigrationBuilder builder, string name,
                          string? schema = null, string? version = null) {
  ...
  public static MigrationBuilder CreatePostgresExtension(
      this MigrationBuilder builder, string name, string? schema = null,
      string? version = null) => EnsurePostgresExtension(builder, name, schema,
                                                         version);
  ...
  public static MigrationBuilder
  DropPostgresExtension(this MigrationBuilder builder, string name) => builder;
}
