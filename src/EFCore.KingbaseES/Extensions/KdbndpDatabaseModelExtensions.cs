...
public static class KdbndpDatabaseModelExtensions {
  ...
  GetOrAddPostgresExtension(this DatabaseModel model, string? schema,
  ...
  GetPostgresExtensions(this DatabaseModel model) =>
  ...
  GetPostgresEnums(this DatabaseModel model) =>
