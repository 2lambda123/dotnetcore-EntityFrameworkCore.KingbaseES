...
internal static class ExpressionVisitorExtensions {
  ...
  /// </returns>
  public static IReadOnlyList<Expression>
  Visit(this ExpressionVisitor visitor, IReadOnlyList<Expression> nodes) {
  ...
  /// <summary>
  ///     Visits an expression, casting the result back to the original
  ///     expression type.
  /// </summary>
  /// <typeparam name="T">The type of the expression.</typeparam>
  /// <param name="visitor">The expression visitor.</param>
  /// <param name="nodes">The expression to visit.</param>
  /// <param name="callerName">The name of the calling method; used to report to
  /// report a better error message.</param> <returns>
  ///     The modified expression, if it or any subexpression was modified;
  ///     otherwise, returns the original expression.
  /// </returns>
  /// <exception cref="InvalidOperationException">The visit method for this node
  /// returned a different type.</exception>
  public static IReadOnlyList<T>
  VisitAndConvert<T>(this ExpressionVisitor visitor, IReadOnlyList<T> nodes,
  ...
  /// </returns>
  public static IReadOnlyList<T> Visit<T>(this ExpressionVisitor visitor,
