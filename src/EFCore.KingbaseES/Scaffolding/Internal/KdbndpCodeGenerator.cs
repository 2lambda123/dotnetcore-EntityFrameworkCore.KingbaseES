...
public class KdbndpCodeGenerator : ProviderCodeGenerator {
  private static readonly MethodInfo _useKdbndpMethodInfo =
      typeof(KdbndpDbContextOptionsBuilderExtensions)
  ...
  /// <summary>
  ///     Constructs an instance of the <see cref="KdbndpCodeGenerator" />
  ///     class.
  /// </summary>
  ...
  public override MethodCallCodeFragment GenerateUseProvider(
      string connectionString, MethodCallCodeFragment? providerOptions) =>
      new(_useKdbndpMethodInfo,
          providerOptions is null? new object[] {
            connectionString
          }: new object[] { connectionString,
                            new NestedClosureCodeFragment("x",
                                                          providerOptions) });
}
