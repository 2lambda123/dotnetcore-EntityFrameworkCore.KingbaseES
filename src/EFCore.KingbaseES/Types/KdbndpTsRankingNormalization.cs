...
///     This is used with the ranking functions in <see
///     cref="KdbndpFullTextSearchLinqExtensions" />. See
///     http://www.KingbaseES.org/docs/current/static/textsearch-controls.html#TEXTSEARCH-RANKING
///     for more information about the behaviors that are controlled by this
///     value.
/// </summary>
[Flags]
...
public enum KdbndpTsRankingNormalization {
  ...
  /// <summary>
  ///     Divides the rank by the mean harmonic distance between extents (this
  ///     is implemented only by ts_rank_cd).
  /// </summary>
