...
public static class KdbndpAnnotationNames {
  ...
  public const string ValueGenerationStrategy =
      Prefix + "ValueGenerationStrategy";
  ...
  /// <summary>
  ///     Identifies the type of the KingbaseES type of this column (e.g. array,
  ///     range, base).
  /// </summary>
  public const string PostgresTypeType = Prefix + "PostgresTypeType";

  /// <summary>
  ///     If this column's data type is an array, contains the data type of its
  ///     elements. Otherwise null.
  /// </summary>
  public const string ElementDataType = Prefix + "ElementDataType";

  /// <summary>
  ///     If the index contains an expression (rather than simple column
  ///     references), the expression is contained here. This is currently
  ...
  /// </summary>
  [Obsolete(
      "Replaced by built-in EF Core support, use HasComment on entities or properties.")]
