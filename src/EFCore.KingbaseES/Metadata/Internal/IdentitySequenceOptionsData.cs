...
/// </summary>
public class IdentitySequenceOptionsData
    : IEquatable<IdentitySequenceOptionsData> {
  /// <summary>
  ///     This is an internal API that supports the Entity Framework Core
  ///     infrastructure and not subject to the same compatibility standards as
  ...
  Get(IReadOnlyAnnotatable annotatable) =>
  ...
  public static IdentitySequenceOptionsData Deserialize(string? value) {
    ...
    try {
      ...
      throw new ArgumentException(
          $"Couldn't deserialize {nameof(IdentitySequenceOptionsData)} from annotation",
          ex);
    }
  }
  ...
  private static bool AsBool(string? value) => value is not null &&
                                               bool.Parse(value);
  ...
  public virtual bool Equals(
      IdentitySequenceOptionsData? other) => !(other is null) &&
  ...
  public override bool
      Equals(object? obj) => obj is IdentitySequenceOptionsData other &&
                             Equals(other);
  ...
  ///     when updating to a new Entity Framework Core release.
  /// </summary>
  public override int GetHashCode() => HashCode.Combine(StartValue, IncrementBy,
                                                        MinValue, MaxValue,
                                                        IsCyclic,
                                                        NumbersToCache);
}
