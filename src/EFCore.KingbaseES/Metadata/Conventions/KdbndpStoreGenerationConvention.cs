...
/// <summary>
///     A convention that ensures that properties aren't configured to have a
///     default value, as computed column or using a <see
///     cref="KdbndpValueGenerationStrategy" /> at the same time.
/// </summary>
public class KdbndpStoreGenerationConvention : StoreGenerationConvention {
  ...
  public override void ProcessPropertyAnnotationChanged(
    ...
    if (annotation is null || oldAnnotation?.Value is not null) {
      return;
    }
    ...
    case RelationalAnnotationNames.DefaultValue:
      if (propertyBuilder.HasValueGenerationStrategy(null, fromDataAnnotation)
              is null &&
          propertyBuilder.HasDefaultValue(null, fromDataAnnotation)
              is not null) {
      ...
      if (property.TryGetDefaultValue(storeObject, out _)) {
        throw new InvalidOperationException(
            RelationalStrings.ConflictingColumnServerGeneration(
                "KdbndpValueGenerationStrategy", property.Name,
                "DefaultValue"));
      }
