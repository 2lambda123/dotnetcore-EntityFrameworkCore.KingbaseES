...
/// <summary>
///     A convention that configures the default model <see
///     cref="KdbndpValueGenerationStrategy" /> as <see
///     cref="KdbndpValueGenerationStrategy.IdentityByDefaultColumn" /> for
///     newer KingbaseES versions, and <see
///     cref="KdbndpValueGenerationStrategy.SerialColumn" /> for pre-10.0
///     versions.
/// </summary>
public class KdbndpValueGenerationStrategyConvention
  ...
  ///     cref="KdbndpValueGenerationStrategyConvention" />.
  /// </summary>
  ...
  /// <param name="postgresVersion">The KingbaseES version being targeted. This
  /// affects the default value generation strategy.</param>
  ...
  /// </summary>
  protected virtual ProviderConventionSetBuilderDependencies Dependencies {
    get;
  }
  ...
  /// </summary>
  protected virtual RelationalConventionSetBuilderDependencies
  ...
  /// <inheritdoc />
  public virtual void
  ProcessModelFinalizing(IConventionModelBuilder modelBuilder,
      ...
      foreach (var property in entityType.GetDeclaredProperties()) {
        ...
        if (declaringTable.Name != null!) {
          strategy = property.GetValueGenerationStrategy(
              declaringTable, Dependencies.TypeMappingSource);
          ...
          var declaringView =
              property.GetMappedStoreObjects(StoreObjectType.View)
                  .FirstOrDefault();
          if (declaringView.Name != null!) {
            strategy = property.GetValueGenerationStrategy(
                declaringView, Dependencies.TypeMappingSource);
            if (strategy == KdbndpValueGenerationStrategy.None &&
          ...
          if (strategy == KdbndpValueGenerationStrategy.Sequence) {
            ...
            property.Builder.HasDefaultValueSql(
                RelationalDependencies.UpdateSqlGenerator
                    .GenerateObtainNextSequenceValueOperation(sequence.Name,
                                                              sequence.Schema));
          }
        }
      }
    ...
    bool IsStrategyNoneNeeded(IReadOnlyProperty property,
