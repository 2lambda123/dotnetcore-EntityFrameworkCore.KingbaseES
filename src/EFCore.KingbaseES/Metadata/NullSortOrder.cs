...
public enum NullSortOrder {
  /// <summary>
  ///     Represents an unspecified sort order. The database default will be
  ///     used.
  /// </summary>
  Unspecified = 0,
  ...
  /// </summary>
  /// <remarks>
  ///     This is the default when <see cref="SortOrder.Descending" /> is
  ///     specified.
  /// </remarks>
  NullsFirst = 1,
  ...
  /// </summary>
  /// <remarks>
  ///     This is the default when <see cref="SortOrder.Descending" /> is not
  ///     specified.
  /// </remarks>
  NullsLast = 2,
}
